...
const Shop = () => {
  ...
  const { isError, isFetching, data } = useFetch(`http://localhost:1099/api/products?page=${currentPage}&limit=${limit}`);
    ...
    <>
      ...
      <div>
        ...
        <section className="padding-x">
          <ShopProducts setCurrentPage={setCurrentPage} currentPage={currentPage} isError={isError} isFetching={isFetching} data={data} />
        </section>
